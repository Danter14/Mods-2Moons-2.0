	    ...
	    {else}
			...
			<td style="white-space: nowrap;">
				{if $currentPlanet.action}
					<!-- Addon Astéroïdes -->
					{if $currentPlanet.planet.id_owner == NULL}
						<a href='?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=1&amp;target_mission=16'>
							<img src="{$dpath}img/asteroid_icons.png" alt="" width="20" height="20">
						</a>
					{else}
