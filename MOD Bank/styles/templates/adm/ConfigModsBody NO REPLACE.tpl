{include file="overall_header.tpl"}
    <form action="" method="post">
        ...
        <table width="70%" cellpadding="2" cellspacing="2">
            <tr>
                <th colspan="2">{$LNG.msg_commision_bank_title}</th><th>&nbsp;</th>
            </tr>
            <tr>
                <td>{$LNG.msg_commision_bank}</td>
                <td><input name="commision_bank" maxlength="3" size="60" value="{$commision_bank}" type="text"></td>
                <td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$LNG.msg_commision_bank_desc}"></td>
            </tr>
            <tr>
                <td colspan="3"><input value="{$LNG.se_save_parameters}" type="submit"></td>
            </tr>
